def train():
    ...
    MODEL_S3_PATH = "onnx/model-" + os.environ.get("model_version", "latest") + ".onnx"
    print(f"Model will be available in S3 storage under: {MODEL_S3_PATH}")
    ...
    bucket_name = "rhods"
    s3_client.upload_file(onnx_path_local, bucket_name, MODEL_S3_PATH)
